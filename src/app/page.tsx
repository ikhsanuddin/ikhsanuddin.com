      ...
      <section id="section-skills" className="min-h-screen py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-12">
            {/* Technical Lead */}
            <div className="p-8 bg-light-accent/5 dark:bg-white/5 border border-light-accent/10 dark:border-white/10 rounded-2xl">
              <h3 className="text-3xl font-bold mb-6 text-light-primary dark:text-dark-secondary">Technical Lead</h3>
              <ul className="space-y-3 text-light-accent dark:text-gray-300 mb-6">
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>End-to-end delivery and technical decision-making</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Design and implement scalable, maintainable architectures for complex software systems</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Collaborate with cross-functional teams to drive project success</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Stay up-to-date with industry trends and best practices, driving innovation and improvement</span>
                </li>
              </ul>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
                {[
                  ...
                  <div
                    key={tool}
                    className="p-3 bg-light-primary/10 dark:bg-dark-secondary/10 border border-light-primary/20 dark:border-dark-secondary/20 rounded-lg text-sm text-center hover:bg-light-primary/20 dark:hover:bg-dark-secondary/20 transition-colors"
                  >
                    {tool}
                  </div>
                ))}
            ...
            {/* Senior Developer */}
            <div className="p-8 bg-light-accent/5 dark:bg-white/5 border border-light-accent/10 dark:border-white/10 rounded-2xl">
              <h3 className="text-3xl font-bold mb-6 text-light-secondary dark:text-dark-accent">Senior Developer (Frontend & Backend)</h3>
              <ul className="space-y-3 text-light-accent dark:text-gray-300 mb-6">
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Mentor and guide junior developers, fostering growth and technical excellence</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Contribute to technical strategy, providing thought leadership and vision</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Develop and maintain expertise in latest-cutting-edge technologies</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Ensuring code standards, providing technical guidance, and conducting thorough code reviews</span>
                </li>
              </ul>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
                {[
                  ...
                  <div
                    key={tool}
                    className="p-3 bg-light-secondary/10 dark:bg-dark-accent/10 border border-light-secondary/20 dark:border-dark-accent/20 rounded-lg text-sm text-center hover:bg-light-secondary/20 dark:hover:bg-dark-accent/20 transition-colors"
                  >
                    {tool}
                  </div>
                ))}
            ...
            {/* DevOps */}
            <div className="p-8 bg-light-accent/5 dark:bg-white/5 border border-light-accent/10 dark:border-white/10 rounded-2xl">
              <h3 className="text-3xl font-bold mb-6 text-light-accent dark:text-dark-accent">DevOps</h3>
              <ul className="space-y-3 text-light-accent dark:text-gray-300 mb-6">
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Manage infrastructure with code (IaC)</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Monitor and log system performance</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Work with cloud and containers (Docker, Kubernetes)</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-light-secondary dark:text-dark-accent mt-1">→</span>
                  <span>Set up automated testing and deployment (CI/CD)</span>
                </li>
              </ul>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
                {[
                  ...
                  <div
                    key={tool}
                    className="p-3 bg-light-accent/10 dark:bg-dark-accent/10 border border-light-accent/20 dark:border-dark-accent/20 rounded-lg text-sm text-center hover:bg-light-accent/20 dark:hover:bg-dark-accent/20 transition-colors"
                  >
                    {tool}
                  </div>
                ))}
